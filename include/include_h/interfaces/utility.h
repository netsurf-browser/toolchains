...
struct UtilityIFace
{
	...
	void APICALL (*SortList)(struct UtilityIFace *Self, struct List * list, struct Hook * cmpHook);
	void APICALL (*SortMinList)(struct UtilityIFace *Self, struct MinList * list, struct Hook * cmpHook);
};
